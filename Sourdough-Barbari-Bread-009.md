...
### Observations
- The A/C was running throughout the night and at 13:00 the bulk had risen to only about 2.4L (120%). I put it in the oven and warmed it up just a little to speed up the fermentation.
...
![After the bulk fermentation: note the change in volume](images/barbari-008/4-after-bulk-rise.jpg)
...
### Observations
- 3:00 delay because the bulk hadn't risen to 150% volume yet.
...
### Observations
- 3:00 delay
- The dough, after a 150% bulk rise was extremely unmanageable and broke almost easily. Last time, I let the dough rise up to 160% during the bulk rise and it was still quite strong. This might be because the dough was made of type 850 flour. This time I used type 500 flour and apparently a 150% rise is still too much for it. Next time go for a 135% bulk rise when working with type 500 flour.
...
Hours of bench rise will turn the skin of the dough rounds dry. Try glazing the rounds right after shaping so the final rise won't dry their skin. Glaze the rounds more abundantly and with a rather wet ferni so that the long rise will not completely dry it up and enough wetness remains on the crust to delay its hardening in the oven and there will be enough time for oven spring. Leave the patterning to be done right before baking.
...
### Observations
- 3:00 delay
- Since the dough has already lost a lot of its strength, cut the final rise down to 1 hour until 18:15.
...
The first round to have been shaped should be baked first. If the glaze is too much dried, apply a little more of it on top of the round. Grooving should be done right before baking (not right after shaping) because the pattern begins to dissappear and the glaze dries up the more that the shaped dough rests. Punch the pattern by putting the 6 fingers on your both hands (3 middle fingers on each hand) together in a row to form the likeness of a comb, then punch the comb deep into the flattened dough to create about 5-6 rows of finger-holes that go from the left end of the round to the right end of it. The rows should be about 2cm apart. Leave unpunched margins of about 2cm at the top and bottom and 1cm at the sides.
